...
class WordRep(nn.Module):
    ...
    def forward(self, word_inputs,feature_inputs, word_seq_lengths, char_inputs, char_seq_lengths, char_seq_recover):
        ...
        word_embs =  self.word_embedding(word_inputs) # word embedding size: 100
        word_list = [word_embs]
        for idx in range(self.feature_num):
            word_list.append(self.feature_embeddings[idx](feature_inputs[idx]))  # feature embedding size: 20
        if self.use_char:
