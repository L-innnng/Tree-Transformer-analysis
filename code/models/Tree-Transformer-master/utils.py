...
class data_utils():
    def __init__(self, args):
        ...
        if not os.path.exists(self.dict_path) or args.train:
            self.process_training_data()
        elif args.test or args.PP_ambiguity or args.gp_MVRR or args.gp_overt_object or args.gp_verb_transitivity:
    ...
    def process_training_data(self):
        ...
        dd = []
        word_count = {}
        for line in open(self.train_path): # process training data
            w_list = []
            for word in line.strip().split():
                if 'N' in word:
                    ...
                    w = sub_words[0] # get first token as word
    ...
    def train_data_yielder(self):
        ...
        max_len = []
        for epo in range(1000000000): # 1000000000
            ...
            for line in self.training_data:
                ...
                if input_vec is not None:
                    ...
                    if len(batch['input']) == self.batch_size: # send to tain() each batch
