...
# the ground-truth span representation for Tree Transformer
vbrackets = ['[(1, 7), (2, 4), (1, 4), (4, 7), (5, 7)]','[(4, 7), (1, 7), (2, 4), (1, 4)]']
nbrackets = ['[(1, 7), (2, 4), (2, 7), (4, 7), (5, 7)]','[(4, 7), (1, 7), (2, 4), (2, 7)]']
right_brackets = ['[(1, 7), (2, 4), (1, 4), (4, 7), (5, 7)]','[(4, 7), (1, 7), (2, 4), (1, 4)]','[(1, 7), (2, 4), (2, 7), (4, 7), (5, 7)]','[(4, 7), (1, 7), (2, 4), (2, 7)]']
...
brackets = pd.read_csv('data/pp_ambiguity/tt_brackets.txt', dtype={'uid':str}, sep='\[]', header = None, names=['bracket'])
...
def fre_data(mark):
    ...
    for i in range(top_num):
        V_proportions.append(len(data[(data['label'] == 'V')&(data[c] == top_p[i][0])])/top_p[i][1])
        N_proportions.append(len(data[(data['label'] == 'N')&(data[c] == top_p[i][0])])/top_p[i][1])
    ...
    #ax.set_title("Noun vs verb attachment proportions for frequent prepositions in the dataset")
    ax.legend(loc="upper right")

    plt.savefig(mark+'_portion_data.png')
    plt.show()
...
# 3. Noun vs verb attachment proportions for frequent prepositions/verbs in the labeled dataset.
fre_data('p')
fre_data('v')

# 4. Noun vs verb attachment proportions for frequent prepositions/verbs from the Tree Transformer.
fre_model('p')
fre_model('v')

# 5. Be/have confusion matrix
